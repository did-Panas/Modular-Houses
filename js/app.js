    ...
    (() => {
        ...
        function formFieldsInit(options = {
            ...
            document.body.addEventListener("focusout", (function(e) {
                ...
                if ("INPUT" === targetElement.tagName || "TEXTAREA" === targetElement.tagName) {
                    ...
                    if (targetElement.hasAttribute("data-validate") && "" !== targetElement.value) formValidate.validateInput(targetElement);
                }
            }));
        ...
        function initSliders() {
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                modules: [ Navigation, Pagination, Thumb, Autoplay, Parallax ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 5,
                ...
                navigation: {
                    prevEl: ".main-block__btn-prev",
                    nextEl: ".main-block__btn-next"
                },
                thumbs: {
                    swiper: {
                        modules: [ Navigation ],
                        el: ".thumbs-mini-slider",
                        spaceBetween: 5,
                        loop: true,
                        slidesPerView: 3,
                        navigation: {
                            prevEl: ".thumbs-mini-slider__btn-prev",
                            nextEl: ".thumbs-mini-slider__btn-next"
                        }
                    }
                }
            });
            if (document.querySelector(".slider-card__slider")) new core(".slider-card__slider", {
                ...
                navigation: {
                    prevEl: ".slider-card__btn-prev",
                    nextEl: ".slider-card__btn-next"
                },
                thumbs: {
                    swiper: {
                        el: ".slider-card__thumbs-container",
                        slidesPerView: 4,
                        spaceBetween: 5,
                        breakpoints: {
                            250: {
            ...
            if (document.querySelector(".slider-card__slider")) new core(".interior-card__slider", {
                ...
                grabCursor: true,
                pagination: {
                    el: ".interior-card__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".interior-card__btn-prev",
                    nextEl: ".interior-card__btn-next"
                }
            });
        }
        window.addEventListener("load", (function(e) {
...
***************************************************************************** */
        ...
        preloader();
        const script_element = document.getElementById("phone__input");
        const maskOptions = {
            mask: "+{38}(000)000-00-00"
        };
        IMask(script_element, maskOptions);
        document.addEventListener("afterPopupOpen", (function(e) {
            const element = document.getElementById("phone__input-popup");
            const maskOptions = {
                mask: "+{38}(000)000-00-00"
            };
        ...
        if (calcForm) {
            const formDecorSelect = calcForm.innerDecor, formFloorSelect = calcForm.floorType, formInsulationSelect = calcForm.insulType, calcButton = document.querySelector(".form-calc__button"), onlyHouseCostField = document.querySelector("#house-cost"), houseAreaField = document.querySelector("#house-area"), roofCostField = document.querySelector("#roof-cost"), innerDecorCostField = document.querySelector("#inner-decor-cost"), floorCostField = document.querySelector("#floor-cost"), bathPrepCostField = document.querySelector("#bath-cost"), insulationCostField = document.querySelector("#insulation-cost"), totalCostField = document.querySelector("#total-cost"), resultsBlock = document.querySelector(".res-calc__body");
            const squareMeterHouseCost = 16e3, squareMeterRoofCost = 2e3, plasterboardFirstMeter = 690, plasterboardNextMeter = 370, falsebeamFirstMeter = 1923, falsebeamNextMeter = 1036, floorMeter = 600, bathPreparationCost = 2e4, insulOf200Cost = 400, insulOf250Cost = 800;
            const normalNum = str => String(str).replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, "$1 ");
            function getRoofCost(roofCheckbox, houseAreaRes, squareMeterRoofCost) {
                if (roofCheckbox) return houseAreaRes * squareMeterRoofCost; else return 0;
            }
            function getInnDecorCost(innDecSelectedVal, houseAreaRes) {
                if (2 == innDecSelectedVal) {
                    let sum = plasterboardFirstMeter;
                    for (let i = 0; i < houseAreaRes - 1; i++) sum += plasterboardNextMeter;
                    return sum;
                } else if (3 == innDecSelectedVal) {
                    let sum = falsebeamFirstMeter;
                    for (let i = 0; i < houseAreaRes - 1; i++) sum += falsebeamNextMeter;
                    return sum;
                } else return 0;
            }
            function getFloorCost(floorSelectedVal, houseAreaRes) {
                let res = 0;
                if (2 == floorSelectedVal) res = floorMeter * houseAreaRes;
                return res;
            }
            function getBathPrepCost(bathPrepCheckbox) {
                return bathPrepCheckbox ? bathPreparationCost : 0;
            }
            function getInsulationCost(insulationSelectedVal, houseAreaRes) {
                if (2 == insulationSelectedVal) return insulOf200Cost * houseAreaRes; else if (3 == insulationSelectedVal) return insulOf250Cost * houseAreaRes; else return 0;
            }
            let setScrollingDown = block => {
                block.scrollIntoView(true);
            };
            calcButton.addEventListener("click", (function() {
                const lengthInput = calcForm.houseLength.value, widthInput = calcForm.houseWidth.value, roofCheckbox = calcForm.roofType.checked, innDecSelectedVal = formDecorSelect.value, floorSelectedVal = formFloorSelect.value, bathPrepCheckbox = calcForm.bathPrep.checked, insulationSelectedVal = formInsulationSelect.value;
                const houseAreaRes = lengthInput * widthInput, onlyHouseCostRes = squareMeterHouseCost * houseAreaRes, roofCostRes = getRoofCost(roofCheckbox, houseAreaRes, squareMeterRoofCost), innerDecorCostRes = getInnDecorCost(innDecSelectedVal, houseAreaRes), floorCostRes = getFloorCost(floorSelectedVal, houseAreaRes), bathPrepCostRes = getBathPrepCost(bathPrepCheckbox), insulationCostRes = getInsulationCost(insulationSelectedVal, houseAreaRes), totalCostRes = onlyHouseCostRes + roofCostRes + innerDecorCostRes + floorCostRes + bathPrepCostRes + insulationCostRes;
                onlyHouseCostField.innerHTML = normalNum(onlyHouseCostRes);
                houseAreaField.innerHTML = houseAreaRes;
                roofCostField.innerHTML = normalNum(roofCostRes);
                innerDecorCostField.innerHTML = normalNum(innerDecorCostRes);
                floorCostField.innerHTML = floorCostRes;
                bathPrepCostField.innerHTML = normalNum(bathPrepCostRes);
                insulationCostField.innerHTML = normalNum(insulationCostRes);
                totalCostField.innerHTML = normalNum(totalCostRes);
                setScrollingDown(resultsBlock);
            }));
        }
        window["FLS"] = true;
        isWebp();
